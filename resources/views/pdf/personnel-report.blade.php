...
<div class="title">List Authorize</div>
...
<tr class="{{ $rowCount % 2 === 0 ? 'row-even' : 'row-odd' }}">
    ...
    <td>{{ \Carbon\Carbon::parse($row->ts_received)->format('Y-m-d') }}</td>
    <td>{{ \Carbon\Carbon::parse($row->ts_received)->format('H:i:s') }}</td>
    <td>{{ \Carbon\Carbon::parse($row->ts)->format('Y-m-d') }}</td>
    <td>{{ \Carbon\Carbon::parse($row->ts)->format('H:i:s') }}</td>
