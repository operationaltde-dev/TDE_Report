...
class PersonnelReport extends Component
{
    ...
    public function exportPdf()
    {
        ...
        if ($totalRows < $chunkSize) {
            ...
            $html = view('pdf.personnel-report', [
                'reports'         => $reports,
            ...
            $pdfPath = storage_path(
                "app/Personnel-Report_{$start}_to_{$end}.pdf"
            );
        ...
        $query->chunk($chunkSize, function ($reports) use (
            ...
            $path = storage_path(
                "app/temp/Personnel-Report_{$start}_to_{$end}_Part-{$index}.pdf"
            );
        ...
        $zipPath = storage_path(
            "app/Personnel-Report_{$start}_to_{$end}.zip"
        );
    ...
    public function exportExcel()
    {
        ...
        return Excel::download(
            ...
            "Personnel-Report_{$start}_to_{$end}.xlsx"
        );
    }
